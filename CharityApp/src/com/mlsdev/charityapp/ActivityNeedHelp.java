...
import com.mlsdev.charityapp.fragments.FragmentNeedHelpPeople;
import com.mlsdev.charityapp.fragments.NeedHelpCategoriesFragment;
...
public class ActivityNeedHelp extends DialogActivity {
    ...
    public AlertDialog showSearchPeopleDialog(final int oldDistance, final int newDistance,final int categoryId, final boolean isPushMessage, final String description) {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(this);

        alertDialogBuilder.setTitle(getString(R.string.no_people_text, oldDistance));
        alertDialogBuilder
                .setMessage(isPushMessage?getString(R.string.search_to_push_range, newDistance):
    ...
    public void showCreateNotificationDialog() {
        ...
        final EditText etDescription = (EditText) layout.findViewById(R.id.etNotif);
        ...
        btPositive.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(description.isEmpty()){
                    Toast.makeText(ActivityNeedHelp.this,getString(R.string.empty_description_error),Toast.LENGTH_SHORT).show();
                } else {
                    mSearchPeopleTask = new SearchPeopleTask(ActivityNeedHelp.this,0,1,0,true,description).execute();
                    mSendNotifDialog.dismiss();
                    showProgressDialog();
                }
    ...
    class SearchPeopleTask extends AsyncTask<Void,Integer,Void> {
        ...
        SearchPeopleTask(Context context,int minRadius, int maxRadius, int id, boolean isPushSearch, String description) {
        ...
        protected Void doInBackground(Void... params) {
            ...
            if(mIsPushSearch){
                ...
                String id = Request.sendMessage(ActivityNeedHelp.this, mMinRadius, mMaxRadius, mDescription);
                ...
                people = Request.getPeople(mContext,mMinRadius,mMaxRadius, mId);
            }
            return null;
        }
        ...
        protected void onPostExecute(Void v) {
            ...
            if(people!= null){
                if(people.size()==0){
                    ...
                    if(newDistance!=1){
                        showSearchPeopleDialog(mMaxRadius,newDistance, mId,mIsPushSearch,mDescription);
                    } else {
                        showNoResultDialog();
                    }
                } else {
    ...
    private void showNoResultDialog() {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(this);
        alertDialogBuilder
                .setMessage(getString(R.string.no_results_text))
                .setCancelable(true);
        AlertDialog alertDialog = alertDialogBuilder.create();
        alertDialog.show();
    }
    ...
    protected void onStop() {
        super.onStop();
        if(mSearchPeopleTask!=null&&mSearchPeopleTask.getStatus()== AsyncTask.Status.RUNNING){
