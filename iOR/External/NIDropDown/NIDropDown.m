...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    v.backgroundColor = [UIColor colorWithRed:0.18 green:0.18 blue:0.18 alpha:1.0];
    cell.selectedBackgroundView = v;
    
    if(IS_IOS7_AND_UP) {
        cell.backgroundColor = [UIColor colorWithRed:0.18 green:0.18 blue:0.18 alpha:1.0];
    }
    
    if(indexPath.row == 0) {
        UIImageView *dividerImgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, cell.contentView.frame.size.height - 5, 320, 2)];
